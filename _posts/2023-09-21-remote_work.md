...
不管是 IC 还是管理者，远程办公面临的最大问题可能是沟通。大家要不断适应异步沟通的方式。

工具方面，我用过的 Slack 非常不错，特有的 thread 保证了信息的集中 。文档协作工具我们用 Confluence，只要能有协同编辑就好。Task 跟进我用的 Jira。此外我是 Google WorkSpace 的高频用户，比如每日会议都会在 Google Meeting 上列出来（包括我希望别人不打扰我的时间），这样对于提高自己的工作效率以及和你协同的同事都是好事。
...
上海 Lock Down 远程结束后，作为工程师我特意问了我的直属 leader。关于我自己远程期间的办公效率，得到了非常正面的肯定，表示我是少数能够在远程状态下保持效率的工程师。而作为团队 Tech Lead，我观察了团队成员在远程期间的代码提交、oncall 效率、沟通效率等方面的一些细节，在这个将近 10 人的团队里能在远程状态下保持工作效率的不会超过 3 人。不过，观察 LeanCloud 的同事却发现他们非常适应远程，这某种程度上也说明 LeanCloud 同事的内驱力很强。
